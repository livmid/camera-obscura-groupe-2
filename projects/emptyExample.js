    ...
    const responseDescription = await fetch(
      "https://cameraobscuraapi-production.up.railway.app/gpt",
      {
        ...
        body: JSON.stringify({
          ...
          Important notes: please make sure your description in the beginning is two sentences long and not any less. I ask you to give me all your answers in strict JSON format without any additional text and without any errors. You do not surround your code by "\`\`\`" since you're writing a JSON file and not a README file. You have to be strict with the format. The answer has to be precisely written in that way and no other way, every time for every input: 
